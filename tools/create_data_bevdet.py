...
def nuscenes_data_prep(root_path, info_prefix, version, can_bus_path=None, max_sweeps=10, train_half=False):
    ...
    nuscenes_converter.create_nuscenes_infos(
        root_path, info_prefix, version=version, max_sweeps=max_sweeps, train_half=train_half, can_bus_path=can_bus_path)


def add_ann_adj_info(extra_tag, dataroot, nuscenes_version, train_half=False):
...
if __name__ == '__main__':
    ...
    print('add_ann_infos')
    add_ann_adj_info(extra_tag, dataroot=root_path, nuscenes_version=train_version, train_half=train_half)